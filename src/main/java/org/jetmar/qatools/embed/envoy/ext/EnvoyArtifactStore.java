 ...
 */
public class EnvoyArtifactStore extends ArtifactStore {
    private IDownloadConfig _downloadConfig;
    private IDirectory _tempDirFactory;
    private ITempNaming _executableNaming;

    public EnvoyArtifactStore(IDownloadConfig downloadConfig, IDirectory tempDirFactory, ITempNaming executableNaming, IDownloader downloader) {
    ...
    public IExtractedFileSet extractFileSet(Distribution distribution) throws IOException {
        ...
        try {
            ...
            return extractor.extract(_downloadConfig, artifact,
                    new EnvoyFilesToExtract(_tempDirFactory, _executableNaming, fileSet));
        } catch (Exception e) {
