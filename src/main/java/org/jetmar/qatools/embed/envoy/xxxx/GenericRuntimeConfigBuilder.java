...
public class GenericRuntimeConfigBuilder extends AbstractBuilder<IRuntimeConfig> {
	...
	private static final TypedProperty<TempPath> TEMP_PATH = TypedProperty.with(TempPath.class);
	...
	public GenericRuntimeConfigBuilder tempPath(String path) {
		set(TEMP_PATH,new TempPath(path));
		return this;
	}
	...
	static class TempPath extends ImmutableContainer<String> {

		public TempPath(String value) {
			super(value);
		}
	}
